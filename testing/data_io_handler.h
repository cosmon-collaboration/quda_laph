...
namespace LaphEnv {
 ...
 // *                                                                               *
 // *    (a) a FileListInfo object and an IOHandlerFM file ID string                *
 // *                                                                               *
 ...
 // *       -- a numbytes(ioh,K) function, where ioh is an IOHandlerFM, must be     *
 ...
 // *                                                                               *
 // *       -- a write(ioh, const V&) must be defined (ioh is an IOHandlerFM object)*
