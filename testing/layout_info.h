...
// *                                                                 *
// *       <LatticeLayoutInfo>                                       *
// *          <XYZTSizes>24 24 24 48</XYTZSizes>                     *
// *       </LatticeLayoutInfo>                                      *
// *                                                                 *
...
class LayoutInfo
{
  ...
  static std::vector<int> latt_sizes;

  static std::vector<int> num_partitions;
  
  static std::vector<int> rank_latt_sizes;
 ...
 public:
  ...
  static const std::vector<int>& getLattSizes()
   {return latt_sizes;}

  static const std::vector<int>& getCommNumPartitions()
   {return num_partitions;}

  static const std::vector<int>& getRankLattSizes()
   {return rank_latt_sizes;}
 ...
 private:
  ...
  static int linearSiteIndex_lexico(const std::vector<int>& loc_coords, 
                                    const std::vector<int>& loc_sizes);
