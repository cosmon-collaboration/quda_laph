...
//       <CUDASloppyPrecision>double</CUDASloopyPrecision> (or single)
//    </QudaInfo>
...
void QudaInfo::init(const XMLHandler& xml_in, bool echo)
{
 ...
 if (echo){
    ...
    xmlout.put_child("CPUPrecision",(cpu_prec==QUDA_DOUBLE_PRECISION)?"double":"single");
    xmlout.put_child("CUDAPrecision",(cuda_prec==QUDA_DOUBLE_PRECISION)?"double":"single");
    xmlout.put_child("CUDASloppyPrecision",(cuda_prec_sloppy==QUDA_DOUBLE_PRECISION)?"double":"single");
