...
class LaphZnNoise
{
 ...
 public:
   ...
   Array<cmplx> generateLapHQuarkSourceForSink(int Textent, int Nspin, int nEigs); 

   Array<cmplx> generateLapHQuarkSource(int timeValue, int Textent, 
                                        int Nspin, int nEigs);
...
inline cmplx LaphZnNoise::z1_generate()
{    
 return values[0];
}
