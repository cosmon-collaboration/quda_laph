...
// eig_param.ortho_block_size = eig_ortho_block_size;
 eig_param.block_size = 1;   // needed for uniform initial guess to get through to GPU
...
// eig_param.check_interval = eig_check_interval;
 ...
 eig_param.ortho_dim_size_local=LayoutInfo::getRankLattExtents()[LayoutInfo::Ndim-1];

 eig_param.preserve_deflation = QUDA_BOOLEAN_FALSE;  // do not keep eigenvectors in gpu device memory
