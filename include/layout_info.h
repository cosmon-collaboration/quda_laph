...
public:
  ...
  static void init(const XMLHandler &xml_in, const std::vector<int> npartitions,
                   bool echo = true);

  static const std::vector<int> &getLattExtents() { return latt_extents; }
  ...
  static const std::vector<int> &getMyCommCoords() { return my_comm_coords; }

  static const int &getMyRank() { return my_rank; }

  static const int &getLatticeNumSites() { return latt_nsites; }

  static const int &getRankLatticeNumSites() { return rank_latt_nsites; }

  static const int &getNumRanks() { return num_ranks; }

  static const int &getMyStartParity() { return my_start_parity; }

  static const int Ndim;

  static std::vector<int>
  getCommCoordsFromLatticeCoords(const std::vector<int> &latt_coords);
  ...
  // The input lattice quantity in "src" is assumed to be in even-odd site
  // order, then "dest" is output in  lexicographic site order.
