...
int main(int argc, char *argv[]) {
  ...
  const int nmom = 1 , blockSizeMomProj = 1 , n1 = 1 , n2 = 1 ;
  ...
  double _Complex host_mom[ 3*nmom*nspat ] ;
  ...
  double _Complex return_array[ n1*n2*nmom*X[3] ] = {} ;
  std::cout<<sizeof(return_array) << std::endl ;

  // todo create some pretend quarks
  void **host_quark = NULL , **host_quark_bar = NULL ;
